...
- [x] T010: npm run build を通しtsを解消
- [x] T011: release/word-highlighter.zip 生成(manifest/icons/_locales/dist)
- [x] T012: legal/PRIVACY.md と TERMS.md(外部通信なし・データ収集なし・$3買い切り7日トライアル)
